<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JazzMusic.aspx.cs" Inherits="JazzMusic" %>
            ...
            <div class="wrapper">
                <div class="header">
                    <div style="float: left; margin-left: 110px; margin-top: 20px;">
                        ...
                        <div style="float: left; text-align: left; font-family: tahoma; font-size: 24pt;
                            color: #636363; margin-left: 5px; margin-top: 5px;">
                            Jazz <b>Music</b><br>
                            <span style="float: left; text-align: left; font-family: tahoma; font-size: 8pt;
                                color: #b1b1b1;"><b>&nbsp;</b></span>
                        </div>
                    </div>
                    <div style="float: right; margin-right: 30px; margin-top: 50px; text-align: left;
                        font-family: tahoma; font-size: 11pt; color: #636363;">
                        <b>Online music sharing platform</b><br>
                        <span style="float: left; text-align: left; font-family: tahoma; font-size: 8pt;
                            color: #b1b1b1;"><b>&nbsp;</b></span>
                    </div>
                </div>
                <div class="menu">
                    <div class="menu-text" style="padding-left: 140px; padding-right: 50px;">
                        <a href="Default.aspx" class="nav">Index</a></div>
                    <div class="menu-text">
                        <a href="PopMusic.aspx" class="nav">Pop Music</a></div>
                    <div class="menu-text">
                        <a href="RockMusic.aspx" class="nav">Rock Music</a></div>
                    <div class="menu-text" style="padding-right: 30px;">
                        <a href="OldMusic.aspx" class="nav">Classic Music</a></div>
                    <div class="menu-text">
                        <a href="JazzMusic.aspx" class="nav">Jazz Music</a></div>
<%--                    <div style="float: right; padding-right: 25px; padding-top: 12px;">
                ...
                <div class="first-section">
                    <div id="left">
                        <p align="left">
                            <img src="images/beijing4.jpg" width="646" height="37"></p>
                        <p align="left">
                            <asp:GridView ID="GV1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                OnPageIndexChanging="GV1_PageIndexChanging" CellPadding="4" 
                                ForeColor="#333333" GridLines="None" 
                                onselectedindexchanged="GV1_SelectedIndexChanged" PageSize="20" 
                                Width="640px">
                        ...
                        <table width="322" height="606" border="0">
                            <tr>
                                <td height="336" align="left" valign="top">
                                    <p>
                                        <img src="images/6.jpg" width="317" height="30"></p>
                            ...
                            <tr>
                                <td height="352" align="left" valign="top">
                                    <p>
                                        <img src="images/music.gif" width="307" height="352"></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <map name="Map">
                    <area shape="rect" coords="228,8,289,24" href="#">
                </map>
                <map name="Map2">
                    <area shape="rect" coords="217,7,290,27" href="#">
                </map>
                <map name="Map3">
                    <area shape="rect" coords="226,6,283,27" href="#">
                </map>
                <map name="Map4">
                    <area shape="rect" coords="226,8,289,29" href="#">
                </map>
            </div>
    </form>
</body>
