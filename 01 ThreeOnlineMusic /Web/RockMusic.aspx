<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RockMusic.aspx.cs" Inherits="RockMusic" %>
...
<div style="float:left;  text-align:left; font-family:tahoma; font-size:24pt; color:#636363; margin-left:5px;margin-top:5px;">
    Online <b>Music</b><br><span style="float:left;  text-align:left; font-family:tahoma; font-size:8pt; color:#b1b1b1;"><b>
    &nbsp;</b></span>
</div>

</div>

<div style="float:right; margin-right:30px; margin-top:50px; text-align:left; font-family:tahoma; font-size:11pt; color:#636363;">
    <b>Online music sharing platform</b><br><span style="float:left;  text-align:left; font-family:tahoma; font-size:8pt; color:#b1b1b1;"><b>
    &nbsp;</b></span>
</div>
...
<div class="menu-text" style="padding-right:30px;"><a href="OldMusic.aspx" class="nav">
    Classic Music</a></div>
<div class="menu-text"><a href="JazzMusic.aspx" class="nav">Jazz Music</a></div>
...
<div id="left">
  <p align="left"><img src="~/images/beijing2.jpg" width="646" height="37" runat="server"></p>
  <p align="left">
