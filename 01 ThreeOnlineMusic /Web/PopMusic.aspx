<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopMusic.aspx.cs" Inherits="PopMusic" %>
...
<div style="float:left;  text-align:left; font-family:tahoma; font-size:24pt; color:#636363; margin-left:5px;margin-top:5px;">Online <b>Music</b><br><span style="float:left;  text-align:left; font-family:tahoma; font-size:8pt; color:#b1b1b1;"><b>&nbsp;</b></span>
</div>

</div>

<div style="float:right; margin-right:30px; margin-top:50px; text-align:left; font-family:tahoma; font-size:11pt; color:#636363;"><b> Online music sharing platform</b><br><span style="float:left;  text-align:left; font-family:tahoma; font-size:8pt; color:#b1b1b1;"><b>&nbsp;</b></span>
</div>

</div>
<div class="menu">
<div class="menu-text" style="padding-left:140px;padding-right:50px;"><a href="Default.aspx"class="nav">Index</a></div>
<div class="menu-text"><a href="PopMusic.aspx"class="nav">Pop Music</a></div>
<div class="menu-text"><a href="RockMusic.aspx" class="nav">Rock Music</a></div>
<div class="menu-text" style="padding-right:30px;"><a href="OldMusic.aspx" class="nav">Classic Music</a></div>
<div class="menu-text"><a href="JazzMusic.aspx" class="nav">Jazz Muisc</a></div>
...
<div id="left">
  <p align="left"><img src="images/beijing1.jpg" width="646" height="37"></p>
  <p align="left">
      <asp:GridView ID="GV1" runat="server" AllowPaging="True" 
          AutoGenerateColumns="False" onpageindexchanging="GV1_PageIndexChanging" 
          Width="640px" CellPadding="4" ForeColor="#333333" GridLines="None" 
          PageSize="20">
...
<div id="right">
  <table width="322" height="606" border="0">
    ...
    <tr>
      <td height="352" align="left" valign="top"><p><img src="images/music.gif" width="307" height="352"></p>
        </td>
    </tr>
  </table>
</div>
