...
<head runat="server">
    <title>MUSIC UPLOADING AND MANAGERMENT SYSTEM</title>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td valign="center" background="images/bg.gif" height="279">
                                    <table height="120" cellspacing="0" cellpadding="0" width="369" align="center" border="0">
                                        <tbody>
                                            <tr>
                                                <td width="155">
                                                    <img height="140" src="images/music1.jpg" usemap="#Map" border="0" 
                                                        style="width: 149px">
                                                </td>
                                                <td valign="top" align="left" width="214">
                                                    <table cellspacing="0" cellpadding="0" width="167" border="0">
                                                        <tbody>
                                                            <tr>
                                                                <td valign="bottom" width="167" class="style1">
                                                                    &nbsp;<span class="auto-style1">&nbsp;&nbsp;&nbsp; USER LOGIN</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="123">
                                                                        ...
                                                                        <tr>
                                                                            <td valign="center" colspan="2" height="25">
                                                                                ...
                                                                                <asp:Label ID="Label1" runat="server" Visible="False"></asp:Label>
                                                                                    ...
                                                                                    &nbsp;&nbsp;
                                                                                    <asp:ImageButton ID="clean" runat="server" ImageUrl="images/b_clean.gif" OnClick="clean_Click" Height="19px" Width="20px" />
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        </form>
